...
- Screen-space reflections have no Hi-Z acceleration and no roughness-cone blur, and metal reflections use an untinted F0 because the thin G-buffer stores no albedo; no ray tracing, planar reflections, or glass transmission.
