...
void Renderer::createMvpDescriptorSetLayout()
{
    ...
    // The pipeline layout references this layout so descriptor binding is explicit.
...
void Renderer::createDescriptorSets()
{
    ...
    // Each frame gets its own descriptor so CPU writes target the same frame's
    // uniform buffer that the GPU reads during rendering.
