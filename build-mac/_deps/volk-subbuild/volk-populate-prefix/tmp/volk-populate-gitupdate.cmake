...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "vulkan-sdk-1.4.328.1"
  WORKING_DIRECTORY "/Users/zihanw/Projects/VulkanEngine/build-mac/_deps/volk-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "vulkan-sdk-1.4.328.1")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("vulkan-sdk-1.4.328.1" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: vulkan-sdk-1.4.328.1")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/vulkan-sdk-1.4.328.1")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"vulkan-sdk-1.4.328.1\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/zihanw/Projects/VulkanEngine/build-mac/_deps/volk-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/zihanw/Projects/VulkanEngine/build-mac/_deps/volk-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
