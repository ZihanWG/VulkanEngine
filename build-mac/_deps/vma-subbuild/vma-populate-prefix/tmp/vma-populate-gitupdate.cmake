...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "v3.3.0"
  WORKING_DIRECTORY "/Users/zihanw/Projects/VulkanEngine/build-mac/_deps/vma-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/zihanw/Projects/VulkanEngine/build-mac/_deps/vma-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/zihanw/Projects/VulkanEngine/build-mac/_deps/vma-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
